...
from concensusFn import least_misery, mean, multiplicative, most_pleasure, borda_count
...
class TestConcensusFn(unittest.TestCase):
    ...
    def test_borda_count(self):
        expected = Series([25, 15, 15, 25, 24, 25, 18.5, 26, 23.5, 23], index=self.matrix.keys())
